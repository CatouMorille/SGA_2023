Lucien Brätschi est, comme d'habitude, en train de dormir à poings fermés.
    ...
    * Le laisser dormir
    ...
    === awake ===
    « C'est quoi c'raffut ?! C'est quand même pas possible, quand c'est pas c'tablard de taureau qui beugle, y'a quelqu'un pour venir me réveiller ! Y'a pas moyen de faire un somme par ici ! »
...
=== final === 
Vous avez à peine tourné les talons que Lucien s'est déjà recouché dans l'herbe. 
    -> END
